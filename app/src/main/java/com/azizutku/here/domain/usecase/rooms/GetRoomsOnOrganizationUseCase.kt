...
class GetRoomsOnOrganizationUseCase @Inject constructor(private val repository: RoomsRepository) {

    suspend fun execute(): Flow<DataState<List<Room>>> = repository.getRoomsOnOrganization()
